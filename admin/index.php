...
<form id="jan_planos" ng-submit="ctrl.cadastrar(ctrl.cad_planos)">
	<fieldset>
		<legend>Cadastro de planos</legend>
		<input type="text" title="Nome plano" placeholder="Nome do novo plano" required ng-model="ctrl.cad_planos.plano" />
		<input type="number" title="Valor do plano" placeholder="Valor do plano" required ng-model="ctrl.cad_planos.valor" />
...
<nav class="animated fadeInLeftBig">
	...
	<a href="listar-carne" title="Conferir carnes"><img src="../imagens/money.png" class="icon" /></a>
...
<script src="../js/listCarneCtrl.js"></script>
</body>
</html>